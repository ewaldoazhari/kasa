...
@section('title')
    <title>Masukan Data Kasir</title>
@endsection
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Masukan Data Kasir</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('home') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('employees.index') }}">Kasir</a></li>
                            <li class="breadcrumb-item active">Masukan Data</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('employees.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="outlet_id" id="outlet_id"
                                        required class="form-control {{ $errors->has('password') ? 'is-invalid':'' }}">
