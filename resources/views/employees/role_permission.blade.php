    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Akses</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <div class="container-fluid">
                <div class="row">
                    {{--<div class="col-md-4">--}}
                        ...
                        {{--<form action="{{ route('employees.add_permission') }}" method="post">--}}
                            {{--@csrf--}}
                    ...
                    <div class="col-md-8">
                        ...
                        <form action="{{ route('employees.roles_permission') }}" method="GET">
                            <div class="form-group">
                        ...
                        @if (!empty($permissions))
                            <form action="{{ route('employees.setRolePermission', request()->get('role')) }}" method="post">
                                @csrf
